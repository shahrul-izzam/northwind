...
namespace Northwind.Web {
    ...
    public partial class NorthwindAspNetApplication : WebApplication {
        ...
        static NorthwindAspNetApplication() {
        ...
        #endregion
        public NorthwindAspNetApplication() {
            InitializeComponent();
			InitializeDefaults();
        }
        ...
        private void NorthwindAspNetApplication_DatabaseVersionMismatch(object sender, DevExpress.ExpressApp.DatabaseVersionMismatchEventArgs e) {
#if EASYTEST
            e.Updater.Update();
            e.Handled = true;
#else
        ...
        private void InitializeComponent() {
            ...
            this.module3 = new Northwind.Module.NorthwindModule();
            ...
            // 
            this.ApplicationName = "Northwind";
